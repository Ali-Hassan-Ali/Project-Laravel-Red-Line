...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.clients')  .' - '. __('dashboard.edit'))
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.clients.update', $user->id) }}" method="post" enctype="multipart/form-data">
